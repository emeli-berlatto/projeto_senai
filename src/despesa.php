...
if ($_SERVER['REQUEST_METHOD'] == 'DELETE') {
    echo json_encode($despesa->deleteById($_GET['id']));
    return;
}

if ($_SERVER['REQUEST_METHOD'] == 'PUT') {
    $data = json_decode(file_get_contents("php://input"), true);
    echo json_encode($despesa->updateById($_GET['id'], $data));
    return;
}

if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $data = json_decode(file_get_contents("php://input"), true);
    echo json_encode($despesa->create($data));
    return;
}
...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    echo json_encode($despesa->getAll());
    return;
}